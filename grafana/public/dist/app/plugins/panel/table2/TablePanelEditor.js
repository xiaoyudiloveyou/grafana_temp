...
var TablePanelEditor = /** @class */ (function (_super) {
    __extends(TablePanelEditor, _super);
    function TablePanelEditor() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onToggleShowHeader = function () {
            _this.props.onOptionsChange(__assign(__assign({}, _this.props.options), { showHeader: !_this.props.options.showHeader }));
        };
        _this.onToggleFixedHeader = function () {
            _this.props.onOptionsChange(__assign(__assign({}, _this.props.options), { fixedHeader: !_this.props.options.fixedHeader }));
        };
        _this.onToggleRotate = function () {
            _this.props.onOptionsChange(__assign(__assign({}, _this.props.options), { rotate: !_this.props.options.rotate }));
        };
        _this.onFixedColumnsChange = function (_a) {
            var target = _a.target;
            _this.props.onOptionsChange(__assign(__assign({}, _this.props.options), { fixedColumns: target.value }));
        };
        return _this;
    }
