...
describe('SingleStatCtrl', function () {
    ...
    SingleStatCtrl.prototype.dashboard = {
        isTimezoneUtc: jest.fn(function () { return true; }),
    };
    ...
    singleStatScenario('showing last iso time instead of value', function (ctx) {
        ctx.setup(function () {
            ...
            ctx.ctrl.dashboard.isTimezoneUtc = function () { return false; };
        });
    ...
    singleStatScenario('showing last iso time instead of value (in UTC)', function (ctx) {
        ctx.setup(function () {
            ...
            ctx.ctrl.panel.valueName = 'last_time';
            ctx.ctrl.panel.format = 'dateTimeAsIso';
            ctx.ctrl.dashboard.isTimezoneUtc = function () { return true; };
        });
    ...
    singleStatScenario('When mapping null values and no data', function (ctx) {
        ctx.setup(function () {
            ctx.input = []; // No data
            ctx.ctrl.panel.valueMaps = [{ value: 'null', text: 'XYZ' }];
        });
        it('value should be null', function () {
...
//# sourceMappingURL=singlestat.test.js.map