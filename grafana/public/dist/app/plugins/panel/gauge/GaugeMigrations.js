...
export var gaugePanelChangedHandler = function (options, prevPluginId, prevOptions) {
    // This handles most config changes
    var opts = sharedSingleStatPanelChangedHandler(options, prevPluginId, prevOptions);
