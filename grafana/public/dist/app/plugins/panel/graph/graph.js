...
import { getValueFormat, getDisplayProcessor, getFlotPairsConstant, } from '@grafana/ui';
import { provideTheme, getCurrentTheme } from 'app/core/utils/ConfigProvider';
import { toUtc, DataFrameView } from '@grafana/data';
    ...
    function GraphElement(scope, elem, timeSrv) {
        ...
        this.getContextMenuItemsSupplier = function (flotPosition, linksSupplier) {
            return function () {
                ...
                return __spread(items, dataLinks);
            };
        };
