...
var GraphLegend = /** @class */ (function (_super) {
    ...
    GraphLegend.prototype.sortLegend = function () {
        var _this = this;
        var seriesList = __spread(this.props.seriesList) || [];
