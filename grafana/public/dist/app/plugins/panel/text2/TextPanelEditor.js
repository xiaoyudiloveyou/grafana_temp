...
var TextPanelEditor = /** @class */ (function (_super) {
    __extends(TextPanelEditor, _super);
    function TextPanelEditor() {
        ...
        _this.onModeChange = function (item) {
            return _this.props.onOptionsChange(__assign(__assign({}, _this.props.options), { mode: item.value }));
        };
        _this.onContentChange = function (evt) {
            _this.props.onOptionsChange(__assign(__assign({}, _this.props.options), { content: evt.target.value }));
        };
        return _this;
    }
