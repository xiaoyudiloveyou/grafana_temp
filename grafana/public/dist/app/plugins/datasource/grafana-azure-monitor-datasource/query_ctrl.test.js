...
describe('AzureMonitorQueryCtrl', function () {
    ...
    beforeEach(function () {
        ...
        AzureMonitorQueryCtrl.prototype.datasource = {
            $q: Q,
            appInsightsDatasource: { isConfigured: function () { return false; } },
            azureMonitorDatasource: { isConfigured: function () { return false; } },
        };
    ...
    describe('when the query type is Azure Monitor', function () {
        ...
        describe('when getOptions for the Metric Names dropdown is called', function () {
            describe('and resourceGroup, metricDefinition, resourceName and metricNamespace have values', function () {
                ...
                beforeEach(function () {
                    ...
                    queryCtrl.datasource.getMetricNames = function (subscriptionId, resourceGroup, metricDefinition, resourceName, metricNamespace) {
                        expect(subscriptionId).toBe('sub1');
                        expect(resourceGroup).toBe('test');
                        expect(metricDefinition).toBe('Microsoft.Compute/virtualMachines');
            ...
            describe('and resourceGroup, metricDefinition, resourceName and metricNamespace do not have values', function () {
                beforeEach(function () {
                    queryCtrl.target.azureMonitor.resourceGroup = 'select';
                    queryCtrl.target.azureMonitor.metricDefinition = 'select';
        ...
        describe('when onMetricNameChange is triggered for the Metric Names dropdown', function () {
            ...
            beforeEach(function () {
                ...
                queryCtrl.datasource.getMetricMetadata = function (subscription, resourceGroup, metricDefinition, resourceName, metricNamespace, metricName) {
