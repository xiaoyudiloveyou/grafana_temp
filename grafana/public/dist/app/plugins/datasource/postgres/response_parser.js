...
var ResponseParser = /** @class */ (function () {
    ...
    ResponseParser.prototype.processQueryResult = function (res) {
        ...
        for (var key in res.data.results) {
            ...
            if (queryRes.series) {
                try {
                    for (var _c = (e_1 = void 0, tslib_1.__values(queryRes.series)), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var series = _d.value;
                        data.push({
                            target: series.name,
            ...
            if (queryRes.tables) {
                try {
                    for (var _e = (e_2 = void 0, tslib_1.__values(queryRes.tables)), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var table = _f.value;
                        table.type = 'table';
