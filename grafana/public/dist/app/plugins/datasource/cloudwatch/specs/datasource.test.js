...
describe('CloudWatchDatasource', function () {
    ...
    describe('When performing CloudWatch query with template variables', function () {
        ...
        it('should generate the correct query for single template variable', function (done) {
            var query = {
                range: { from: 'now-1h', to: 'now' },
                rangeRaw: { from: 1483228800, to: 1483232400 },
                targets: [
        ...
        it('should generate the correct query for multilple template variables', function (done) {
            var query = {
                range: { from: 'now-1h', to: 'now' },
                rangeRaw: { from: 1483228800, to: 1483232400 },
                targets: [
        ...
        it('should generate the correct query for multilple template variables, lack scopedVars', function (done) {
            var query = {
                range: { from: 'now-1h', to: 'now' },
                rangeRaw: { from: 1483228800, to: 1483232400 },
                targets: [
        ...
        it('should generate the correct query for multilple template variables with expression', function (done) {
            var query = {
                range: { from: 'now-1h', to: 'now' },
                rangeRaw: { from: 1483228800, to: 1483232400 },
                targets: [
