    ...
    describe('when interpolating a template variable for the filter', function () {
        ...
        describe('and is single value variable', function () {
            beforeEach(function () {
                ...
                var ds = new StackdriverDataSource(instanceSettings, noopBackendSrv, filterTemplateSrv, timeSrv);
    ...
    describe('when interpolating a template variable for group bys', function () {
        ...
        describe('and is single value variable', function () {
            beforeEach(function () {
                ...
                var ds = new StackdriverDataSource(instanceSettings, noopBackendSrv, groupByTemplateSrv, timeSrv);
