...
export var getLabelKeys = function (datasource, selectedMetricType) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                labelKeys = response.meta
                    ? __spread(Object.keys(response.meta.resourceLabels).map(function (l) { return "resource.label." + l; }), Object.keys(response.meta.metricLabels).map(function (l) { return "metric.label." + l; })) : [];
...
export var getAlignmentPickerData = function (_a, templateSrv) {
    ...
    var options = getAlignmentOptionsByMetric(valueType, metricKind).map(function (option) { return (__assign(__assign({}, option), { label: option.text })); });
    var alignOptions = [
        {
