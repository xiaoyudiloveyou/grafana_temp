            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        elements = __spread(elements, Object.keys(this.labelData.resourceLabels || {}).map(function (l) {
                            return _this.uiSegmentSrv.newSegment({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, segment.type === 'plus-button' ? elements : __spread(elements, [this.removeSegment])];
                }
            });
        });
    };
