...
function queryTree(children, query, queryIndex) {
    ...
    try {
        for (var children_1 = tslib_1.__values(children), children_1_1 = children_1.next(); !children_1_1.done; children_1_1 = children_1.next()) {
            ...
            try {
                for (var namesToMatch_1 = (e_3 = void 0, tslib_1.__values(namesToMatch)), namesToMatch_1_1 = namesToMatch_1.next(); !namesToMatch_1_1.done; namesToMatch_1_1 = namesToMatch_1.next()) {
