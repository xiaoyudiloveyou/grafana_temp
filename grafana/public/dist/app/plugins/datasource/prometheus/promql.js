...
export var OPERATORS = ['by', 'group_left', 'group_right', 'ignoring', 'on', 'offset', 'without'];
...
export var FUNCTIONS = tslib_1.__spread(AGGREGATION_OPERATORS, [
    {
        insertText: 'abs',
        label: 'abs',
