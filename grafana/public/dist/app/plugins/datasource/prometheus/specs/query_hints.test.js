...
describe('getQueryHints()', function () {
    ...
    it('returns no hint for a monotonically decreasing series', function () {
    ...
    it('returns a rate hint for a monotonically increasing series', function () {
    ...
    it('returns no rate hint for a monotonically increasing series that already has a rate', function () {
        var series = [{ datapoints: [[23, 1000], [24, 1001]] }];
        var hints = getQueryHints('rate(metric[1m])', series);
        expect(hints).toEqual(null);
    });
    it('returns a rate hint w/o action for a complex monotonically increasing series', function () {
        var series = [{ datapoints: [[23, 1000], [24, 1001]] }];
    ...
    it('returns a rate hint for a monotonically increasing series with missing data', function () {
