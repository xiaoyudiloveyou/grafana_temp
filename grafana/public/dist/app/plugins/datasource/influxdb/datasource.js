...
var InfluxDatasource = /** @class */ (function (_super) {
    tslib_1.__extends(InfluxDatasource, _super);
    /** @ngInject */
    function InfluxDatasource(instanceSettings, $q, backendSrv, templateSrv) {
        ...
        _this.type = 'influxdb';
        _this.urls = _.map(instanceSettings.url.split(','), function (url) {
            return url.trim();
        });
    ...
    InfluxDatasource.prototype.query = function (options) {
        ...
        var allQueries = _.map(targets, function (target) {
            ...
            queryModel = new InfluxQueryModel(target, _this.templateSrv, scopedVars);
    ...
    InfluxDatasource.prototype.targetContainsTemplate = function (target) {
        ...
        try {
            for (var _c = tslib_1.__values(target.groupBy), _d = _c.next(); !_d.done; _d = _c.next()) {
                var group = _d.value;
                try {
                    for (var _e = (e_2 = void 0, tslib_1.__values(group.params)), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var param = _f.value;
