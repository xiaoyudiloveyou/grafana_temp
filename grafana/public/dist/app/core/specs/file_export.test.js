...
describe('file_export', function () {
    ...
    describe('when exporting series as rows', function () {
        it('should export points in proper order', function () {
            var text = fileExport.convertSeriesListToCsv(ctx.seriesList, { dateTimeFormat: ctx.timeFormat });
            var expectedText = '"Series";"Time";"Value"\r\n' +
    ...
    describe('when exporting series as columns', function () {
        it('should export points in proper order', function () {
            var text = fileExport.convertSeriesListToCsvColumns(ctx.seriesList, { dateTimeFormat: ctx.timeFormat });
            var expectedText = '"Time";"series_1";"series_2"\r\n' +
                '"1500026100";1;11\r\n' +
                '"1500026200";2;12\r\n' +
                '"1500026300";null;13\r\n' +
        ...
        it('should not modify series.datapoints', function () {
            var expectedSeries1DataPoints = ctx.seriesList[0].datapoints.slice();
            var expectedSeries2DataPoints = ctx.seriesList[1].datapoints.slice();
    ...
    describe('when exporting table data to csv', function () {
        it('should properly escape special characters and quote all string values', function () {
            var inputTable = {
                columns: [
                    { title: 'integer_value' },
                    { text: 'string_value' },
                ...
                rows: [
                    ...
                    [501, 'some string with " in the middle', 1e-2, false],
                    [501, 'some string with "" in the middle', 1e-2, false],
                    [501, 'some string with """ in the middle', 1e-2, false],
                    [501, '"some string with " at the beginning', 1e-2, false],
                    [501, 'some string with " at the end"', 1e-2, false],
            ...
            var returnedText = fileExport.convertTableDataToCsv(inputTable, false);
            var expectedText = '"integer_value";"string_value";"float_value";"boolean_value"\r\n' +
                '123;"some_string";1.234;true\r\n' +
                '1000;"some_string";1.234567891;true\r\n' +
...
//# sourceMappingURL=file_export.test.js.map