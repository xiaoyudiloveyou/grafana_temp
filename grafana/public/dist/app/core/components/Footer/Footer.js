        ...
        React.createElement("div", { className: "text-center" },
            React.createElement("ul", null,
                React.createElement("li", null,
                    React.createElement("a", { href: "http://docs.grafana.org", target: "_blank", rel: "noopener" },
                        React.createElement("i", { className: "fa fa-file-code-o" }),
                        " Docs")),
                React.createElement("li", null,
                    React.createElement("a", { href: "https://grafana.com/services/support", target: "_blank", rel: "noopener" },
                        React.createElement("i", { className: "fa fa-support" }),
                        " Support Plans")),
                React.createElement("li", null,
                    React.createElement("a", { href: "https://community.grafana.com/", target: "_blank", rel: "noopener" },
                        React.createElement("i", { className: "fa fa-comments-o" }),
                        " Community")),
                React.createElement("li", null,
                    React.createElement("a", { href: "https://grafana.com", target: "_blank", rel: "noopener" }, appName),
                    ' ',
                ...
                newGrafanaVersionExists && (React.createElement("li", null,
                    React.createElement(Tooltip, { placement: "auto", content: newGrafanaVersion },
                        React.createElement("a", { href: "https://grafana.com/get", target: "_blank", rel: "noopener" }, "New version available!"))))))));
});
