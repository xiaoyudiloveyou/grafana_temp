...
var ManageDashboardsCtrl = /** @class */ (function () {
    ...
    ManageDashboardsCtrl.prototype.initDashboardList = function (result) {
        ...
        try {
            for (var _c = __values(this.sections), _d = _c.next(); !_d.done; _d = _c.next()) {
        ...
        try {
            for (var _c = __values(this.sections), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                if (section.checked && section.id !== 0) {
                    ...
                    (_b = selectedDashboards.dashboardUids).push.apply(_b, __spread(_.map(selected, 'uid')));
                }
            }
        }
    ...
    ManageDashboardsCtrl.prototype.getDashboardsToMove = function () {
        ...
        try {
            for (var _b = __values(this.sections), _c = _b.next(); !_c.done; _c = _b.next()) {
                var section = _c.value;
                var selected = _.filter(section.items, { checked: true });
                selectedDashboards.push.apply(selectedDashboards, __spread(_.map(selected, 'uid')));
            }
        }
