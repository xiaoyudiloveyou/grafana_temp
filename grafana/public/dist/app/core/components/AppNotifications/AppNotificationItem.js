...
var AppNotificationItem = /** @class */ (function (_super) {
    ...
    AppNotificationItem.prototype.render = function () {
        var _a = this.props, appNotification = _a.appNotification, onClearNotification = _a.onClearNotification;
        return (React.createElement(AlertBox, { severity: appNotification.severity, title: appNotification.title, body: appNotification.text, icon: appNotification.icon, onClose: function () { return onClearNotification(appNotification.id); } }));
    };
