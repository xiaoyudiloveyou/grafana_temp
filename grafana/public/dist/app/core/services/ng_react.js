...
function watchProps(watchDepth, scope, watchExpressions, listener) {
    ...
    try {
        for (var watchExpressions_1 = __values(watchExpressions), watchExpressions_1_1 = watchExpressions_1.next(); !watchExpressions_1_1.done; watchExpressions_1_1 = watchExpressions_1.next()) {
            ...
            scope.$on('$destroy', function () {
                if (!attrs.onScopeDestroy) {
                    ...
                    scope.$eval(attrs.onScopeDestroy, {
                        unmountComponent: ReactDOM.unmountComponentAtNode.bind(_this, elem[0]),
                    });
                }
            });
        },
