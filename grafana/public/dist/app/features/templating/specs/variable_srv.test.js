...
describe('VariableSrv', function () {
    ...
    describe('setOptionFromUrl', function () {
        it('sets single value as string if not multi choice', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, setValueMock, setFromUrl;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = tslib_1.__read(setupSetFromUrlTest(ctx), 2), setValueMock = _a[0], setFromUrl = _a[1];
                        return [4 /*yield*/, setFromUrl('one')];
                    case 1:
                        _b.sent();
        ...
        it('sets single value as array if multi choice', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, setValueMock, setFromUrl;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = tslib_1.__read(setupSetFromUrlTest(ctx, { multi: true }), 2), setValueMock = _a[0], setFromUrl = _a[1];
                        return [4 /*yield*/, setFromUrl('one')];
                    case 1:
                        _b.sent();
                        expect(setValueMock).toHaveBeenCalledWith({ text: ['one'], value: ['one'] });
        ...
        it('sets both text and value as array if multiple values in url', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, setValueMock, setFromUrl;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = tslib_1.__read(setupSetFromUrlTest(ctx, { multi: true }), 2), setValueMock = _a[0], setFromUrl = _a[1];
                        return [4 /*yield*/, setFromUrl(['one', 'two'])];
                    case 1:
                        _b.sent();
        ...
        it('sets text and value even if it does not match any option', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, setValueMock, setFromUrl;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = tslib_1.__read(setupSetFromUrlTest(ctx), 2), setValueMock = _a[0], setFromUrl = _a[1];
                        return [4 /*yield*/, setFromUrl('none')];
                    case 1:
                        _b.sent();
        ...
        it('sets text and value even if it does not match any option and it is array', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a, setValueMock, setFromUrl;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = tslib_1.__read(setupSetFromUrlTest(ctx), 2), setValueMock = _a[0], setFromUrl = _a[1];
                        return [4 /*yield*/, setFromUrl(['none', 'none2'])];
                    case 1:
                        _b.sent();
...
function setupSetFromUrlTest(ctx, model) {
    ...
    var variableSrv = new VariableSrv($q, ctx.$location, ctx.$injector, ctx.templateSrv, ctx.timeSrv);
    var finalModel = tslib_1.__assign({ type: 'custom', options: ['one', 'two', 'three'].map(function (v) { return ({ text: v, value: v }); }), name: 'test' }, model);
    var variable = new CustomVariable(finalModel, variableSrv);
    ...
    return [variable.setValue, function (val) { return variableSrv.setOptionFromUrl(variable, val); }];
}
