...
var AppConfigCtrlWrapper = /** @class */ (function (_super) {
    tslib_1.__extends(AppConfigCtrlWrapper, _super);
    ...
    AppConfigCtrlWrapper.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            model && (React.createElement("div", { className: "gf-form" },
                ...
                model.enabled && (React.createElement(Button, { variant: "danger", onClick: this.disable, className: withRightMargin }, "Disable"))))));
    };
