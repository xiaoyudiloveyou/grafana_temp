...
var DashboardPage = /** @class */ (function (_super) {
    ...
    DashboardPage.prototype.renderInitFailedState = function () {
        ...
        return (React.createElement("div", { className: "dashboard-loading" },
            React.createElement(AlertBox, { severity: AppNotificationSeverity.Error, title: initError.message, body: getMessageFromError(initError.error) })));
    };
    DashboardPage.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classes },
            ...
            React.createElement("div", { className: "scroll-canvas scroll-canvas--dashboard" },
                React.createElement(CustomScrollbar, { autoHeightMin: "100%", setScrollTop: this.setScrollTop, scrollTop: updateScrollTop, updateAfterMountMs: 500, className: "custom-scrollbar--page" },
                    ...
                    React.createElement("div", { className: gridWrapperClasses },
                        ...
                        React.createElement(DashboardGrid, { dashboard: dashboard, isEditing: isEditing, isFullscreen: isFullscreen, scrollTop: approximateScrollTop }))))));
    };
