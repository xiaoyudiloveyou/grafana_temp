...
describe('timeSrv', function () {
    ...
    beforeEach(function () {
        timeSrv = new TimeSrv(rootScope, jest.fn(), location, timer, new ContextSrvStub());
    ...
    describe('init time from url', function () {
        ...
        it('should ignore refresh if time absolute', function () {
            location = {
                search: jest.fn(function () { return ({
                    from: '20140410T052010',
                    to: '20140520T031022',
        ...
        describe('data point windowing', function () {
            it('handles time window specfied as interval string', function () {
                location = {
                    search: jest.fn(function () { return ({
                        time: '1410337645000',
                        'time.window': '10s',
            ...
            it('handles time window specified in ms', function () {
                location = {
                    search: jest.fn(function () { return ({
                        time: '1410337645000',
                        'time.window': '10000',
...
//# sourceMappingURL=TimeSrv.test.js.map