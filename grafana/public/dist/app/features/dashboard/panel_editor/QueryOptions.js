...
// Components
import { EventsWithValidation, Input, InputStatus, Switch, FormLabel, } from '@grafana/ui';
    ...
    function QueryOptions(props) {
        ...
        _this.renderOptions = function () {
            ...
            return Object.keys(_this.allOptions).map(function (key) {
                ...
                if (queryOptions[key]) {
                    return (React.createElement(DataSourceOption, tslib_1.__assign({ key: key }, options, { onChange: _this.onDataSourceOptionChange(panelKey), onBlur: _this.onDataSourceOptionBlur(panelKey), value: value })));
                }
