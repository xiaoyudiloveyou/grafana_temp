...
var DashboardModel = /** @class */ (function () {
    ...
    DashboardModel.prototype.getSaveModelClone = function (options) {
        ...
        copy.templating = {
            list: _.map(this.templating.list, function (variable) {
    ...
    DashboardModel.prototype.cleanUpRepeats = function () {
        ...
        // remove panels
        _.pull.apply(_, __spread([this.panels], panelsToRemove));
    ...
    DashboardModel.prototype.cleanUpRowRepeats = function (rowPanels) {
        ...
        _.pull.apply(_, __spread([rowPanels], panelsToRemove));
        _.pull.apply(_, __spread([this.panels], panelsToRemove));
    };
    ...
    DashboardModel.prototype.toggleRow = function (row) {
        ...
        // remove panels
        _.pull.apply(_, __spread([this.panels], rowPanels));
    ...
    DashboardModel.prototype.autoFitPanels = function (viewHeight, kioskMode) {
        var currentGridHeight = Math.max.apply(Math, __spread(this.panels.map(function (panel) {
    ...
    DashboardModel.prototype.expandParentRowFor = function (panelId) {
        ...
        try {
            for (var _c = __values(this.panels), _d = _c.next(); !_d.done; _d = _c.next()) {
                ...
                if (panel.collapsed) {
                    try {
                        for (var _e = (e_11 = void 0, __values(panel.panels)), _f = _e.next(); !_f.done; _f = _e.next()) {
                            var rowPanel = _f.value;
