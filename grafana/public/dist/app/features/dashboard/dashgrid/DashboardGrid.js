...
var DashboardGrid = /** @class */ (function (_super) {
    ...
    function DashboardGrid() {
        ...
        _this.isInView = function (panel) {
            ...
            var height = panel.gridPos.h * GRID_CELL_HEIGHT + 40;
    ...
    DashboardGrid.prototype.renderPanels = function () {
        ...
        var _loop_1 = function (panel) {
            ...
            panelElements.push(React.createElement("div", { key: id, className: panelClasses, id: 'panel-' + id, ref: function (elem) {
                    _this.panelRef[id] = elem;
                } },
                React.createElement(DashboardPanel, { panel: panel, dashboard: this_1.props.dashboard, isEditing: panel.isEditing, isFullscreen: panel.fullscreen, isInView: panel.isInView })));
        };
        var this_1 = this;
        try {
            for (var _b = tslib_1.__values(this.props.dashboard.panels), _c = _b.next(); !_c.done; _c = _b.next()) {
