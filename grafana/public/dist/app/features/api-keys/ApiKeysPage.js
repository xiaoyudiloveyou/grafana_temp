...
import { DeleteButton, EventsWithValidation, FormLabel, Input } from '@grafana/ui';
...
(function (ApiKeyStateProps) {
    ...
    ApiKeyStateProps["SecondsToLive"] = "secondsToLive";
...
var tooltipText = 'The api key life duration. For example 1d if your key is going to last for one day. All the supported units are: s,m,h,d,w,M,y';
var ApiKeysPage = /** @class */ (function (_super) {
    ...
    function ApiKeysPage(props) {
        ...
        _this.onAddApiKey = function (evt) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                secondsToLive = this.state.newApiKey['secondsToLive'];
    ...
    ApiKeysPage.prototype.renderEmptyList = function () {
        ...
        return (React.createElement(React.Fragment, null,
            !isAdding && (React.createElement(EmptyListCTA, { title: "You haven't added any API Keys yet.", buttonIcon: "gicon gicon-apikeys", buttonLink: "#", onClick: this.onToggleAdding, buttonTitle: " New API Key", proTip: "Remember you can provide view-only API access to other applications." })),
            this.renderAddApiKeyForm()));
    };
    ApiKeysPage.prototype.formatDate = function (date, format) {
        if (!date) {
            return 'No expiration date';
        }
        date = isDateTime(date) ? date : dateTime(date);
        format = format || 'YYYY-MM-DD HH:mm:ss';
        var timezone = getTimeZone(store.getState().user);
            ...
            React.createElement("div", { className: "cta-form" },
                ...
                React.createElement("form", { className: "gf-form-group", onSubmit: this.onAddApiKey },
                    React.createElement("div", { className: "gf-form-inline" },
                        ...
                        React.createElement("div", { className: "gf-form max-width-21" },
                            React.createElement(FormLabel, { tooltip: tooltipText }, "Time to live"),
                            React.createElement(Input, { type: "text", className: "gf-form-input", placeholder: "1d", validationEvents: timeRangeValidationEvents, value: newApiKey.secondsToLive, onChange: function (evt) { return _this.onApiKeyStateUpdate(evt, ApiKeyStateProps.SecondsToLive); } })),
                        React.createElement("div", { className: "gf-form" },
            ...
            React.createElement("table", { className: "filter-table" },
                ...
                apiKeys.length > 0 ? (React.createElement("tbody", null, apiKeys.map(function (key) {
                    return (React.createElement("tr", { key: key.id },
                        ...
                        React.createElement("td", null, _this.formatDate(key.expiration)),
