...
var getStyles = memoizeOne(function () {
    return {
        logsEnter: css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n      label: logsEnter;\n      position: absolute;\n      opacity: 0;\n      height: auto;\n      width: auto;\n    "], ["\n      label: logsEnter;\n      position: absolute;\n      opacity: 0;\n      height: auto;\n      width: auto;\n    "]))),
        logsEnterActive: css(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n      label: logsEnterActive;\n      opacity: 1;\n      transition: opacity ", "ms ease-out ", "ms;\n    "], ["\n      label: logsEnterActive;\n      opacity: 1;\n      transition: opacity ", "ms ease-out ", "ms;\n    "])), transitionDuration, transitionDelay),
        logsExit: css(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n      label: logsExit;\n      position: absolute;\n      opacity: 1;\n      height: auto;\n      width: auto;\n    "], ["\n      label: logsExit;\n      position: absolute;\n      opacity: 1;\n      height: auto;\n      width: auto;\n    "]))),
        logsExitActive: css(templateObject_4 || (templateObject_4 = tslib_1.__makeTemplateObject(["\n      label: logsExitActive;\n      opacity: 0;\n      transition: opacity ", "ms ease-out ", "ms;\n    "], ["\n      label: logsExitActive;\n      opacity: 0;\n      transition: opacity ", "ms ease-out ", "ms;\n    "])), transitionDuration, transitionDelay),
    };
});
/**
