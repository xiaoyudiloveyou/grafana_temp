...
var ButtonRow = function (_a) {
    ...
    return (React.createElement("div", { className: "gf-form-button-row" },
        !isReadOnly && (React.createElement("button", { type: "submit", className: "btn btn-primary", disabled: isReadOnly, onClick: function (event) { return onSubmit(event); }, "aria-label": "Save and Test button" }, "Save & Test")),
