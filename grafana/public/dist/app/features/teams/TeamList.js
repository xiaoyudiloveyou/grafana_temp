    ...
    TeamList.prototype.renderTeam = function (team) {
        ...
        return (React.createElement("tr", { key: team.id },
            ...
            React.createElement("td", { className: "text-right" },
                React.createElement(DeleteButton, { onConfirm: function () { return _this.deleteTeam(team); }, disabled: !canDelete }))));
    };
    TeamList.prototype.renderEmptyList = function () {
        return (React.createElement(EmptyListCTA, { title: "You haven't created any teams yet.", buttonIcon: "gicon gicon-team", buttonLink: "org/teams/new", buttonTitle: " New team", proTip: "Assign folder and dashboard permissions to teams instead of users to ease administration.", proTipLink: "", proTipLinkTitle: "", proTipTarget: "_blank" }));
    };
    TeamList.prototype.renderTeamList = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "page-action-bar" },
                ...
                React.createElement("a", { className: "btn btn-primary" + disabledClass, href: newTeamHref }, "New team")),
