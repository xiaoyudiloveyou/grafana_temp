...
var TeamGroupSync = /** @class */ (function (_super) {
    ...
    TeamGroupSync.prototype.renderGroup = function (group) {
        ...
        return (React.createElement("tr", { key: group.groupId },
            ...
            React.createElement("td", { style: { width: '1%' } },
                React.createElement("a", { className: "btn btn-danger btn-small", onClick: function () { return _this.onRemoveGroup(group); } },
    ...
    TeamGroupSync.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            groups.length === 0 && !isAdding && (React.createElement(EmptyListCTA, { onClick: this.onToggleAdding, buttonIcon: "gicon gicon-team", title: "There are no external groups to sync with", buttonTitle: "Add Group", proTip: headerTooltip, proTipLinkTitle: "Learn more", proTipLink: "http://docs.grafana.org/auth/enhanced_ldap/", proTipTarget: "_blank" })),
