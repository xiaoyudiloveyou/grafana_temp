    ...
    InviteeRow.prototype.render = function () {
        ...
        return (React.createElement("tr", null,
            ...
            React.createElement("td", { className: "text-right" },
                React.createElement("button", { className: "btn btn-inverse btn-small", onClick: this.copyToClipboard },
                    React.createElement("textarea", { readOnly: true, value: invitee.url, style: { position: 'absolute', bottom: 0, right: 0, opacity: 0, zIndex: -10 }, ref: this.copyUrlRef }),
                    "Copy Invite"),
                "\u00A0"),
            React.createElement("td", null,
                React.createElement("button", { className: "btn btn-danger btn-small", onClick: function () { return revokeInvite(invitee.code); } },
